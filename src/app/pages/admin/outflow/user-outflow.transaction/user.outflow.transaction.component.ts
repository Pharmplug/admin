...
@Component({
  ...
  templateUrl: './user.outflow.transaction.component.html',
  styleUrls: ['./user.outflow.transaction.component.css']
})
export class UserOutflowComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(this,this.userTransactionInfo)
